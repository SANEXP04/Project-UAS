class person():
    def _init_(self, nama):  # mendefinisikan constructor
    ...
    @umur.setter
    def umur(self, value):
        self._umur = self._cek(value)  # mengakses private method __cek()
...
class mahasiswa(person):
    def _init_(self, nama, nim=False):  # overriding constructor
        print("construct class Mahasiswa", nama)
        self.nim = nim
        person._init_(self, nama)  # memanggil parent constructor
